...
Después abrí `http://localhost:3000` y `http://localhost:3000/admin.html` en dos pestañas. En el panel se ingresa con cualquier email, una contraseña de 8 caracteres o más y cualquier código de 6 dígitos.
